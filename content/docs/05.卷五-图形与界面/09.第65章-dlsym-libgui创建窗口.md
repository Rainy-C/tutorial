---
title: "第 65 章 · dlsym libgui 创建窗口"
...
- [ ] 知道三条创建图层路径的差别
- [ ] 理解 mangled name 的编码规则（`_ZN` + 长度 + 名字）
- [ ] 会用 `c++filt` 解修饰
- [ ] 知道 C++ 成员函数编译后第一个参数是 `this`
- [ ] 知道用私有库的最大代价是"结构体布局没有头文件保证"
- [ ] 会写符号侦察器，确认设备上有哪些符号

→ 下一章：[第66章-跨版本符号适配](10.第66章-跨版本符号适配)　—— 学会"一套代码适配 Android 5~17"的方法。

...
- [ ] 把 mathlib.h 抄了一遍并编译通过
- [ ] 知道每个函数对应本项目的哪段代码
- [ ] 会用它做一次完整的 W2S
- [ ] 库里所有除法都有除零保护 ★
- [ ] 加了 Lerp / LerpAngle / Clamp 并验证角度插值走最短路

→ 下一章：[第54章-给数学库写测试](10.第54章-给数学库写测试)　—— 用断言驱动的方式给 mathlib 写一套测试，以后每次改数学代码都跑一遍，防止改坏。

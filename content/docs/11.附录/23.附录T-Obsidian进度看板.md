...
每学完一卷，在 [附录Q-动手任务总清单](20.附录Q-动手任务总清单) 的"完成度追踪表"里填一行：
...
:::tip[最有用的一条]
**在 [附录Q-动手任务总清单](20.附录Q-动手任务总清单) 里勾选**——
那份清单是"学习进度"的唯一真相来源。
Dataview 看板只是它的可视化。
:::

→ 返回 [00-开始之前](../00.开始之前/00.开始之前)

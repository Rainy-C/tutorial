---
title: "第 83 章 · Actor / Component 模型"
tags: [教程, 卷七, 引擎, 架构]
day: 53
aliases: [ch83]
---
...
- [ ] 理解 Actor/Component 为什么比"大结构体"好
- [ ] 知道组件是通过指针/链表挂在 Actor 上的
- [ ] 知道 C++ 对象第一个字段通常是 vtable
- [ ] 写出了自己的 demo 引擎并跑起来 ★
- [ ] 能画出 World → Level → Actor 数组 → Actor → 组件链表 的结构图
- [ ] 用 memview 观察过它的内存布局

→ 下一章：[第84章-对象数组与遍历](02.第84章-对象数组与遍历)　—— 掌握从"数组首地址 + 个数"遍历所有对象的完整流程，以及每一步必须做的防御。

---
title: "第 33 章 · NDK 与第一条 ndk-build"
...
忘记为什么的话回看 [第02章-装好第一套工具链](../01.卷一-编程地基/02.第02章-装好第一套工具链) 开头的"先定规矩：东西放哪里"。
:::
...
→ 下一章：[第34章-Android.mk与Application.mk逐行](04.第34章-Android.mk与Application.mk逐行)　—— 把 KLBQ 的两个 `.mk` 文件每一行都讲透，并学会四种常见改造场景。
